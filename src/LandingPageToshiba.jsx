    ...
    return (
      <div dir="rtl" className="min-h-screen bg-white text-gray-900">
        ...
        <nav className="bg-[#e60012] text-white py-3 px-6 flex justify-between items-center shadow-md fixed w-full top-0 z-50">
          ...
          <span className="bg-white text-[#e60012] px-3 py-1 rounded-md shadow">📞 01026270228</span>
        </nav>
        ...
        <div className="pt-16">
          ...
          <header className="max-w-6xl mx-auto flex flex-col md:flex-row items-center bg-white text-gray-900 py-10 rounded-lg shadow-xl px-4 md:px-10 gap-6">
            <div className="md:w-1/2 text-center md:text-right">
              ...
              <div className="mt-2 flex justify-center md:justify-start gap-6">
                <span className="bg-white text-[#e60012] px-4 py-2 rounded-lg shadow-md">📞 01026270228</span>
                <span className="bg-white text-[#e60012] px-4 py-2 rounded-lg shadow-md">📞 01117794282</span>
              </div>
            </div>
          ...
          <section className="max-w-6xl mx-auto py-10 px-4 bg-white rounded-lg">
            <h2 className="text-xl font-semibold text-center mb-6 text-[#e60012]">أبرز منتجات توشيبا</h2>
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
              {items.map((item, index) => (
                ...
                >
                  ...
                  />
                  <div className="p-4">
                    <h3 className="text-lg font-semibold mb-1 text-[#e60012]">{item.title}</h3>
          ...
          <section className="mt-6 bg-white rounded-2xl p-6 max-w-6xl mx-auto">
            ...
            <pre className="whitespace-pre-wrap text-gray-900 text-sm font-bold leading-relaxed">{servicesContent}</pre>
          </section>

          {/* Keywords Section */}
          <div className="mt-10 max-w-6xl mx-auto p-6 bg-white rounded-2xl">
            <h2 className="text-xl font-bold mb-4 text-center text-[#e60012]">الخدمات المتاحة</h2>
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3">
              {keywords.map((word, index) => (
                <span key={index} className="bg-[#e60012] text-white px-3 py-2 rounded-lg text-sm text-center">
                  {word}
                </span>
              ))}
            </div>
          ...
          <footer className="bg-white text-gray-900 border-t border-gray-300 py-6 text-center mt-10 relative">
            <h3 className="text-lg font-semibold mb-4 text-[#e60012]">تواصل معنا</h3>
            <div className="flex justify-center gap-6">
              <span className="bg-[#e60012] text-white px-4 py-2 rounded-lg shadow-md">📞 01026270228</span>
              <span className="bg-[#e60012] text-white px-4 py-2 rounded-lg shadow-md">📞 01117794282</span>
            </div>
            ...
            <p className="text-gray-900 text-xs mt-4">© جميع الحقوق محفوظة — توشيبا</p>
          </footer>
